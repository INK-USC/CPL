...
cd ConvE-master
python3 wrangle_KG.py math
export HDF5_USE_FILE_LOCKING='FALSE'
CUDA_VISIBLE_DEVICES=2 python main-bak.py model ConvE dataset reddit \
...
```
CUDA_VISIBLE_DEVICES=1 python main.py model ComplEx dataset math
```
