        ...
        with torch.set_grad_enabled(args.train or args.search_random_seed or args.grid_search):
            ...
            if args.search_random_seed:
                ...
                if args.train:
                    ...
                    eval_result = inference(lf)
                    with open("results.txt", "a") as fil:
                        hits_at_1 = eval_result['test']['hits_at_1']
                        hits_at_3 = eval_result['test']['hits_at_3']
                        hits_at_5 = eval_result['test']['hits_at_5']
                        hits_at_10 = eval_result['test']['hits_at_10']
                        mrr = eval_result['test']['mrr']
                        print('Hits@1 = {}'.format(hits_at_1),file=fil)
                        print('Hits@3 = {}'.format(hits_at_3),file=fil)
                        print('Hits@5 = {}'.format(hits_at_5),file=fil)
                        print('Hits@10 = {}'.format(hits_at_10),file=fil)
                        print('MRR = {}'.format(mrr),file=fil)
